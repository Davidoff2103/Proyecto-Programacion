...
public class Main {
	...
	public static void turnoJ1(int municion1,int municion2,int vida1,int vida2,int el1,int el2, int ia, int vs) throws InterruptedException {
		...
		while (el1<0 || el1>2) {
			...
			el1=reader.nextInt();
		}//varios controles de errores para comprobar si los valores son validos o no
	...
	public static void turnoJ2(int municion1,int municion2,int vida1,int vida2,int el1,int el2, int ia, int vs) throws InterruptedException {
		...
		if(vs==1) {//si el vs es 1 se muestra y pide por pantalla lo que el jugador 2 quiere hacer
			System.out.println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nJugador 2, elige lo que quieres hacer:");
			el2=reader.nextInt();
		}
		while (el2<0 || el2>2) {		//se introducen controles de error para comprobar si los valores son validos
			System.err.println("El valor no es válido, introduce de nuevo:");
			if(vs==1) {
				el2=reader.nextInt();
			}
	...
	public static void comparacion2(int municion1,int municion2,int vida1,int vida2,int el1,int el2, int ia, int vs) throws InterruptedException {
		if(el1==1) {
			if(municion1>0 && el2==1 && municion1<3 && municion2<3) {
				vida2=vida2-1;
				vida1=vida1-1;
				municion1=municion1-1;
				municion2=municion2-1;
	...
	//** Parámetros de salida: Variables municion1, municion2, vida1, vida2, el1, el2, ia, vs
	//*************************************************************************************************
	public static void comparacion5(int municion1,int municion2,int vida1,int vida2,int el1,int el2, int ia, int vs) throws InterruptedException {
		if(el2==1) {
			if(municion2>=3 && municion1<3 && el1==1) {
				vida1=vida1-3;
				vida2=vida2-1;
				municion1=municion1-1;
				municion2=municion2-3;
	...
	//** Explicación de lo que hace la función: muestra por consola lo que debe hacer el jugador 1 para atacar o defender, la elección.
	...
	public static void turno1(int eleccion1, int eleccion2, int a1, int e1, int s1, int v1, int a2, int e2, int s2, int v2, int ataque, int vida1, int vida2, int i, int vs) throws InterruptedException {
		...
		//Muestra por consola la elección que debe hacer el jugador
		System.out.println("\nTurno JUGADOR 1\n");
	...
	//** Explicación de lo que hace la función: muestra por consola lo que debe hacer el jugador 2 para atacar o defender, la elección (en el caso de la IA es aleatorio)
	...
	//** Explicación de lo que hace la función: muestra por consola lo que sucede en el campo de batalla según la elección de los 2 jugadores.
	...
	public static void jugador1(int el1, int el2, int a1, int e1, int s1, int v1, int a2, int e2, int s2, int v2, int ataque, int vida1, int vida2, int i, int vs) throws InterruptedException {
		...
		//Si la elección y las caracteristicas del combatiente se cumplen se ejecuta lo siguiente
	...
	//*************************************************************************************
	//** Nombre de la función: personajeManolo/Jacobo/George/Toni/Tere
	//** Explicación de lo que hace la función: Muestran los dibujos en el juego de lucha.
	//** Parámetros de entrada: -
	//** Parámetros de salida: -
	//*************************************************************************************
